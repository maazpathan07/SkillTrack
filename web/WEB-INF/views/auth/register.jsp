        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                <div class="ios-auth-card ios-auth-card-wide mx-auto">
                    ...
                    <!-- Social 1-Click OAuth Sign Up (Compact 1-Row) -->
                    <div class="ios-oauth-row">
                        <a href="${pageContext.request.contextPath}/auth/oauth/login?provider=google" class="ios-oauth-pill ios-oauth-pill-google" title="Sign up with Google">
                        ...
                        <a href="${pageContext.request.contextPath}/auth/oauth/login?provider=github" class="ios-oauth-pill ios-oauth-pill-github" title="Sign up with GitHub">
                        ...
                        <a href="${pageContext.request.contextPath}/auth/oauth/login?provider=linkedin" class="ios-oauth-pill ios-oauth-pill-linkedin" title="Sign up with LinkedIn">
                    ...
                    <div class="text-center mt-4 pt-3 border-top">
                        ...
                        <a href="${pageContext.request.contextPath}/login" class="small font-weight-bold ml-1 text-nowrap" style="color: var(--ios-blue);">
