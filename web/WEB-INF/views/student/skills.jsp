                                                    ...
                                                    <tr style="border-bottom: 1px solid #f1f5f9;">
                                                        ...
                                                        <td class="text-right py-3 px-4" style="vertical-align: middle;">
                                                            <form action="${pageContext.request.contextPath}/app/student/skills" method="post" class="d-inline">
                                                                ...
                                                                <button type="submit" class="btn btn-sm btn-outline-danger confirm-delete" style="border-radius: var(--ios-radius-xs); padding: 0.25rem 0.6rem; font-size: 0.8rem;" data-confirm="Remove ${ss.skillName} from your profile?">
                                                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>
                                                                    Remove
                                                                </button>
                                                            </form>
                                                        </td>
