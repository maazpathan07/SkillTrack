    ...
    <c:otherwise>
            ...
            <div class="container py-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="ios-feature-card">
                            <div class="d-flex align-items-center mb-3">
                                <div class="ios-icon-box ios-icon-blue mr-3">
                                ...
                                <div>
                                    <h5 class="font-weight-bold mb-0" style="color: var(--ios-text-primary);">Role Skill Gap Engine</h5>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="ios-feature-card">
                            <div class="d-flex align-items-center mb-3">
                                <div class="ios-icon-box ios-icon-green mr-3">
                                ...
                                <div>
                                    <h5 class="font-weight-bold mb-0" style="color: var(--ios-text-primary);">DSA & Problem Solving Engine</h5>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="ios-feature-card">
                            <div class="d-flex align-items-center mb-3">
                                <div class="ios-icon-box ios-icon-purple mr-3">
                                ...
                                <div>
                                    <h5 class="font-weight-bold mb-0" style="color: var(--ios-text-primary);">Project & Certification Portfolio</h5>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="ios-feature-card">
                            <div class="d-flex align-items-center mb-3">
                                <div class="ios-icon-box ios-icon-orange mr-3">
                                ...
                                <div>
                                    <h5 class="font-weight-bold mb-0" style="color: var(--ios-text-primary);">Placement Cutoff Matcher</h5>
        ...
        <footer class="ios-footer">
            <div class="container">
                ...
                <div class="border-top pt-4 d-flex flex-column flex-sm-row justify-content-between align-items-center text-muted small">
                    <div class="mb-2 mb-sm-0">
                        &copy; 2026 <strong>SkillTrack</strong>. All rights reserved.
                    </div>
                    <div class="d-flex align-items-center">
                        <span class="mr-2">Developed by</span>
                        <a href="https://www.linkedin.com/in/maazpathan/" target="_blank" rel="noopener noreferrer" class="ios-badge ios-badge-blue font-weight-bold" style="text-decoration: none; padding: 0.35rem 0.85rem;">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" class="mr-1" style="vertical-align: -2px;">
                                <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 10.9v8.37H9.2V10.9H6.46M7.83 6.45a1.6 1.6 0 1 0 0 3.2 1.6 1.6 0 0 0 0-3.2z"/>
                            </svg>
                            Maaz Pathan | LinkedIn
                        </a>
                    </div>
                </div>
            </div>
