            ...
            <div class="container">
                ...
                <div class="border-top pt-4 d-flex flex-column flex-sm-row justify-content-between align-items-center text-muted small">
                    <div class="mb-2 mb-sm-0">
                        &copy; 2026 <strong>SkillTrack</strong>. Built on NetBeans 8.2 & Java 8 Architecture.
                    </div>
                    <div class="d-flex align-items-center">
                        <span class="ios-badge ios-badge-gray mr-3">v1.0.0-PRO</span>
                        <span class="font-weight-bold" style="color: var(--ios-green-dark);">
                            <span class="mr-1" style="width: 8px; height: 8px; border-radius: 50%; background: var(--ios-green); display: inline-block;"></span>
                            System Active
                        </span>
                    </div>
                </div>
